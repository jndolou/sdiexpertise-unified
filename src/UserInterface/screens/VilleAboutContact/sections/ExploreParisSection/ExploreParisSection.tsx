  ...
  return (
    <section className="flex flex-col w-full items-start gap-[25px] pt-[60px] pb-0 px-4 relative">
      <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
        ...
        <div className="flex flex-col w-full items-start gap-0.5 relative flex-[0_0_auto]">
          <div className="flex flex-col items-start gap-1 relative self-stretch w-full flex-[0_0_auto]">
            <div className="flex items-center gap-2 pl-3 pr-2 py-0 relative self-stretch w-full flex-[0_0_auto] rounded-xl border-[none] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(142deg,rgba(255,255,255,0.4)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-xl before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_37%,rgba(170,127,251,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
      ...
      <Card className="flex flex-col h-[232px] items-start gap-2.5 px-[52px] py-[39px] relative self-stretch w-full rounded-2xl border border-solid border-[#aa7ffb] [background:url(/frame-435.png)_50%_50%_/_cover] overflow-hidden">
        <CardContent className="p-0 flex flex-col w-[110px] h-12 items-start gap-[3px] p-[5px] relative bg-[#ffffffcc] rounded-[11px] border-[none] shadow-[inset_0px_1.85px_1.85px_#ffffff33,inset_0px_-1.85px_1.85px_#ffffff33] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-[11px] before:[background:linear-gradient(126deg,rgba(255,255,255,1)_0%,rgba(170,127,251,1)_31%,rgba(170,127,251,1)_62%,rgba(255,255,255,1)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
