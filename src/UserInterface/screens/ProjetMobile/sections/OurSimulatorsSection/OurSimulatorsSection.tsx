...
export const OurSimulatorsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-start gap-2.5 px-4 py-[60px] relative">
      <div className="flex flex-col items-start gap-8 relative self-stretch w-full">
        <header className="flex flex-col w-full items-center gap-[15px] relative">
        ...
        {simulators.map((simulator, index) => (
          ...
          >
            <CardContent className="flex flex-col items-center justify-center gap-[17px] p-0 w-full">
              <img
                className="relative w-[216px] h-[159px]"
                alt={simulator.title}
                src={simulator.image}
              />
              ...
              <Button className="inline-flex h-12 items-center justify-center gap-2 px-4 py-3 relative bg-[#faf8fc] rounded-[62px] overflow-hidden shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb,3.63e-16px_2.93px_11.87px_#33333324] hover:bg-[#f5f2f9]">
