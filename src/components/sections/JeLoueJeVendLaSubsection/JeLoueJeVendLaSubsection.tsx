            ...
            <div className="flex flex-col w-full items-start gap-[13px] relative flex-[0_0_auto]">
              ...
              <div className="flex flex-col items-start gap-1 relative self-stretch w-full flex-[0_0_auto] z-0">
                <div className="relative w-full" ref={locationPopoverRef}>
                  <div className="flex items-start gap-2 pl-3 pr-2 py-0 relative self-stretch w-full flex-[0_0_auto] rounded-xl border-[none] bg-[linear-gradient(142deg,rgba(255,255,255,0.4)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-xl before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_37%,rgba(170,127,251,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
                  ...
                  {isLocationPopoverOpen && (locationQuery.length >= 3 || isLoadingSuggestions) && (
                    <div className="absolute top-[calc(100%+8px)] left-0 w-full max-w-[355px] p-0 bg-[#ffffffee] rounded-2xl border border-[#aa7ffb33] shadow-[0px_4px_12px_rgba(0,0,0,0.1)] z-50">
            ...
            <div className="inline-flex flex-col items-center justify-center gap-5 relative flex-[0_0_auto] w-full">
              <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                <PopoverTrigger asChild>
                  <div className="flex items-center gap-2 pl-4 pr-2 py-0 relative self-stretch w-full flex-[0_0_auto] rounded-xl border-[none] bg-[linear-gradient(142deg,rgba(255,255,255,0.4)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-xl before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_37%,rgba(170,127,251,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none cursor-pointer">
