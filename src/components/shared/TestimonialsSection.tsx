...
export const TestimonialsSection = ({
  ...
  const testimonialCards = testimonials.map((testimonial, index) => {
    ...
    return (
      <Card
        key={index}
        className="flex-shrink-0 w-[257px] h-[148px] rounded-2xl overflow-hidden border-[none] shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb] bg-[linear-gradient(142deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-2xl before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_37%,rgba(170,127,251,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none"
      >
        <CardContent className="flex flex-col items-start gap-2 p-4 h-full">
          <div className="flex items-start gap-2 w-full">
            ...
            <div className="flex flex-col h-[37px] items-start flex-1">
              ...
              <h3 className="self-stretch [font-family:'Ubuntu',Helvetica] font-bold text-[#1c1b1b] text-lg tracking-[0] leading-[21.6px]">
                {testimonial.name}
              </h3>

              <time className="[font-family:'Pecita-Book',Helvetica] font-normal text-[#1c1b1b] text-[10px] tracking-[0] leading-[normal] whitespace-nowrap">
                {testimonial.timeAgo}
              </time>
            </div>
          </div>
  ...
  return (
    ...
    >
      ...
      {useScrollArea ? (
        ...
        <div className="flex h-[154px] items-start gap-4 px-0 py-1 w-full overflow-x-scroll">
          <div className="inline-flex items-center gap-4 px-4 py-0">
            {testimonialCards}
          </div>
        </div>
      )}
