...
export const QuoteSection = ({
  ...
  subtitle = "En",
  subtitleHighlight = "4",
  subtitleEnd = "étapes simples, sans engagement.",
  steps = defaultSteps,
...
}: QuoteSectionProps): JSX.Element => {
  return (
    <section
      className={`flex w-full items-start gap-2.5 ${paddingTop} ${paddingBottom} px-4 ${className}`}
    >
            ...
            {steps.map((step, index) => (
              ...
              >
                <CardContent className="flex items-center gap-4 p-4">
                  <div className="flex w-[50px] h-[50px] items-center justify-center gap-8 p-2 rounded-2xl flex-col overflow-hidden border-[none] shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb] bg-[linear-gradient(142deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-2xl before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_37%,rgba(170,127,251,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
