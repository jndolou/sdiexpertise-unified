...
export const MeetUsSection = ({
  title = "Rencontrons-nous",
  description = "Vos projets sont complexes et méritent du temps. Nous connaissons vos contraintes, laissez-nous vous exposer nos solutions",
  checklistItems = defaultChecklistItems,
  primaryButtonText = "Prendre un café",
  secondaryButtonText = "Prévoir un visio",
  imageSrc,
  onPrimaryClick,
  onSecondaryClick,
}: MeetUsSectionProps): JSX.Element => {
  return (
