...
export const HeroSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-center gap-[25px] pt-[25px] pb-0 px-0 relative">
        ...
        <CardContent className="flex flex-col items-center gap-[13px] px-0 py-7 h-full">
          {statsData.map((stat, index) => (
            ...
            >
              ...
              <h3
                className={`relative ${index === 2 ? "w-[140px]" : "w-[101px]"} font-titre-3 font-[number:var(--titre-3-font-weight)] text-dark text-[length:var(--titre-3-font-size)] text-center tracking-[var(--titre-3-letter-spacing)] leading-[var(--titre-3-line-height)] [font-style:var(--titre-3-font-style)]`}
              >
                {stat.title}
              </h3>
