...
export const PartnerSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-start gap-2.5 pt-[60px] pb-[5px] px-4">
      <div className="flex flex-col items-start gap-8 w-full">
              ...
              >
                <CardContent className="flex flex-col items-start gap-[15px] p-4 h-full">
                  ...
                  <div className="flex flex-col items-start gap-2">
                    <h3 className="w-[188px] font-titre-3 font-[number:var(--titre-3-font-weight)] text-dark text-[length:var(--titre-3-font-size)] tracking-[var(--titre-3-letter-spacing)] leading-[var(--titre-3-line-height)] [font-style:var(--titre-3-font-style)]">
                      {card.title}
                    </h3>
                    <p className="w-[188px] font-paragraphe-2-mobile font-[number:var(--paragraphe-2-mobile-font-weight)] text-dark text-[length:var(--paragraphe-2-mobile-font-size)] tracking-[var(--paragraphe-2-mobile-letter-spacing)] leading-[var(--paragraphe-2-mobile-line-height)] [font-style:var(--paragraphe-2-mobile-font-style)]">
                      {card.description}
                    </p>
                  </div>
                </CardContent>
        ...
        <div className="flex flex-col items-end gap-2.5 w-full">
          <Button
            className="h-12 px-4 py-3 bg-[#faf8fc] rounded-[62px] shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb,3.63e-16px_2.93px_11.87px_#33333324] [font-family:'Ubuntu',Helvetica] font-bold text-[#1c1b1b] text-base tracking-[0] leading-[19.2px] hover:bg-[#f0eef4]"
            variant="ghost"
          >
