...
export const LatestPropertiesSection = (): JSX.Element => {
  return (
      ...
      <div className="flex flex-col w-full items-start gap-8">
            ...
            >
              <CardContent className="relative w-full h-full p-0">
                <div className="flex flex-col w-full h-4 items-start justify-center p-3 absolute top-2 left-0 overflow-hidden">
                  <Badge className="flex flex-col w-[57px] h-[18px] items-start justify-center gap-[15px] p-1.5 bg-violet-clair rounded-[25px] shadow-[inset_0px_-1.85px_1.85px_#a271ff] hover:bg-violet-clair border-0">
                ...
                <div className="flex flex-col w-[204px] items-start gap-3.5 pt-[15px] pb-2.5 px-2.5 absolute top-[168px] left-2 bg-[#ffffffcc] rounded-2xl">
                  ...
                  <div className="flex flex-col h-[51px] items-start gap-[5px] w-full">
                    ...
                    <div className="flex w-[85px] h-[31px] items-center justify-center gap-2 p-4 rounded-md overflow-hidden border-[none] shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(142deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-md before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(31,1,66,1)_37%,rgba(30,1,67,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
        ...
        <div className="flex flex-col h-12 items-center justify-center gap-2.5 w-full">
          <div className="flex flex-col items-end gap-2.5 w-full">
            <Link to="/actualites">
              <Button className="inline-flex h-auto items-center justify-center gap-2 px-4 py-3 bg-[#faf8fc] rounded-[62px] overflow-hidden shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb,3.63e-16px_2.93px_11.87px_#33333324] hover:bg-[#faf8fc] border-0">
