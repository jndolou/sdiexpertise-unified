  ...
  return (
    <section className="flex flex-col w-full items-start gap-8 pt-0 pb-[33px] px-4 relative">
      <div className="flex flex-col w-full items-start relative">
        <Card className="items-start gap-4 p-4 w-full border border-solid border-[#aa7ffb] rounded-2xl overflow-hidden shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(142deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)]">
          <CardContent className="flex flex-col items-start gap-4 p-0 w-full">
            ...
            <div className="inline-flex items-center gap-[13px] w-full">
              <Checkbox
                id="consent"
              ...
              <label
                htmlFor="consent"
                className="flex-1 font-paragraphe-2-mobile font-[number:var(--paragraphe-2-mobile-font-weight)] text-dark text-[length:var(--paragraphe-2-mobile-font-size)] tracking-[var(--paragraphe-2-mobile-letter-spacing)] leading-[var(--paragraphe-2-mobile-line-height)] [font-style:var(--paragraphe-2-mobile-font-style)]"
              >
                ...
                <div className="flex flex-col items-start gap-1 w-full">
                  <div className="flex items-start gap-2 pl-3 pr-2 py-0 w-full rounded-xl border-[none] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(142deg,rgba(255,255,255,0.4)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-xl before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_37%,rgba(170,127,251,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none relative">
                    <div className="inline-flex h-11 items-center px-0 py-4">
                      <img
                        className="w-[24.25px] ml-[-0.25px] h-6 mt-[-6.00px] mb-[-6.00px]"
                        alt="Left icon"
                        src="/left-icon.svg"
                      />
                    </div>
            ...
            <p className="[font-family:'Open_Sans',Helvetica] font-normal text-transparent text-xs tracking-[0] leading-3 w-full">
