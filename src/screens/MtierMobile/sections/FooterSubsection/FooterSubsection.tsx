...
const quickActions = [
  { icon: "/flash.svg", label: "Simuler mon DPE" },
  { icon: "/cash.svg", label: "Estimer la valeur de mon bien" },
];
  ...
  return (
    <footer className="flex flex-col w-full items-start gap-12 pt-12 pb-32 px-8 relative bg-transparent rounded-[16px_16px_0px_0px] overflow-hidden border-[none] shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(142deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-[16px_16px_0px_0px] before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_37%,rgba(170,127,251,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
      ...
      <div className="flex items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
        ...
        <button className="inline-flex flex-[0_0_auto] items-center gap-1 relative cursor-pointer bg-transparent border-none p-0">
          <div className="inline-flex gap-1.5 flex-[0_0_auto] items-center relative">
            <img className="relative w-4 h-4" alt="Cart" src="/cart.svg" />
      ...
      <div className="inline-flex items-center gap-[15px] relative flex-[0_0_auto]">
        <Button className="inline-flex h-12 items-center justify-center gap-2 px-4 py-3 relative flex-[0_0_auto] rounded-[62px] overflow-hidden border-[none] shadow-[0px_-1.85px_1.85px_#ececec,inset_0px_1.85px_1.85px_#ffffff] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(145deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-[62px] before:[background:linear-gradient(169deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_36%,rgba(170,127,251,1)_68%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
        ...
        <Button className="inline-flex h-12 items-center justify-center gap-2 px-4 py-3 relative flex-[0_0_auto] bg-[#faf8fc] rounded-[62px] overflow-hidden shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb,3.63e-16px_2.93px_11.87px_#33333324]">
      ...
      <div className="flex flex-col items-start justify-center gap-[23px] relative self-stretch w-full flex-[0_0_auto]">
        {quickActions.map((action, index) => (
          <button
            key={index}
            className={`flex ${index === 0 ? "w-[173px]" : "h-6"} items-${index === 0 ? "center" : "start"} ${index === 0 ? "gap-1.5" : "justify-center gap-2"} relative ${index === 0 ? "flex-[0_0_auto]" : ""} cursor-pointer bg-transparent border-none p-0`}
          >
            <img
            ...
            <div
              className={`flex ${index === 0 ? "w-[153px]" : ""} justify-center ${index === 0 ? "mr-[-6.00px]" : "flex-1 grow"} items-center gap-1 relative`}
            >
      ...
      <div className="flex flex-col items-start gap-4 relative self-stretch w-full flex-[0_0_auto]">
        <nav className="flex items-start justify-center gap-4 relative self-stretch w-full flex-[0_0_auto]">
