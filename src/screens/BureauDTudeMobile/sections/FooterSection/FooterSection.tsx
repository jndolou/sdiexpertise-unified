...
export const FooterSection = (): JSX.Element => {
  return (
    <footer className="flex flex-col w-full items-start gap-12 pt-12 pb-32 px-8 relative bg-transparent rounded-[16px_16px_0px_0px] overflow-hidden border-[none] shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(142deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-[16px_16px_0px_0px] before:[background:linear-gradient(172deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_37%,rgba(170,127,251,1)_70%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
      ...
      <nav className="flex flex-col items-start gap-6 relative w-full">
        {navigationLinks.map((link, index) => (
          <button
            key={index}
            className="flex items-center justify-between relative w-full cursor-pointer bg-transparent border-none p-0"
          >
      ...
      <div className="flex items-start justify-between relative w-full">
        <button className="inline-flex items-center gap-1 relative cursor-pointer bg-transparent border-none p-0">
      ...
      <div className="inline-flex items-center gap-[15px] relative">
        <Button
          variant="ghost"
          className="inline-flex h-12 items-center justify-center gap-2 px-4 py-3 relative rounded-[62px] overflow-hidden border-[none] shadow-[0px_-1.85px_1.85px_#ececec,inset_0px_1.85px_1.85px_#ffffff] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(145deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-[62px] before:[background:linear-gradient(169deg,rgba(255,255,255,0)_0%,rgba(170,127,251,1)_36%,rgba(170,127,251,1)_68%,rgba(255,255,255,0)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none"
        >
          <span className="relative w-fit [font-family:'Ubuntu',Helvetica] font-medium text-[#5d3ca4] text-base tracking-[0] leading-[19.2px] whitespace-nowrap">
            Contactez-nous
          </span>
        </Button>
      ...
      <div className="flex flex-col items-start justify-center gap-[23px] relative w-full">
        <button className="flex items-center gap-1.5 relative cursor-pointer bg-transparent border-none p-0">
          <ZapIcon className="relative w-5 h-5" />
          <div className="flex justify-center items-center gap-1 relative">
            <div className="flex gap-1 flex-1 items-center relative">
      ...
      <div className="flex flex-col items-start gap-8 relative w-full">
        <h3 className="relative mt-[-1.00px] font-titre-3 font-[number:var(--titre-3-font-weight)] text-dark text-[length:var(--titre-3-font-size)] tracking-[var(--titre-3-letter-spacing)] leading-[var(--titre-3-line-height)] [font-style:var(--titre-3-font-style)]">
          Contactez-nous
        </h3>
        ...
        <div className="flex flex-col items-start gap-4 relative w-full">
          <div className="flex items-start gap-4 relative w-full">
            <div className="inline-flex flex-col items-start gap-2 relative">
              ...
              <div className="relative w-fit font-paragraphe-2-desktop font-[number:var(--paragraphe-2-desktop-font-weight)] text-dark text-[length:var(--paragraphe-2-desktop-font-size)] tracking-[var(--paragraphe-2-desktop-letter-spacing)] leading-[var(--paragraphe-2-desktop-line-height)] whitespace-nowrap [font-style:var(--paragraphe-2-desktop-font-style)]">
                8:00 - 19:00
              </div>
            </div>

            <div className="flex flex-col items-start gap-2 relative flex-1">
              <div className="relative mt-[-1.00px] font-parahraphe-3 font-[number:var(--parahraphe-3-font-weight)] text-dark text-[length:var(--parahraphe-3-font-size)] tracking-[var(--parahraphe-3-letter-spacing)] leading-[var(--parahraphe-3-line-height)] [font-style:var(--parahraphe-3-font-style)]">
                Samedi
              </div>
      ...
      <div className="flex flex-col items-start gap-4 relative w-full">
        <div className="flex items-start justify-center gap-4 relative w-full">
          {legalLinks.map((link, index) => (
            <React.Fragment key={index}>
              ...
              <button className="inline-flex justify-center items-center gap-1 relative cursor-pointer bg-transparent border-none p-0">
        ...
        <div className="relative font-parahraphe-3 font-[number:var(--parahraphe-3-font-weight)] text-dark text-[length:var(--parahraphe-3-font-size)] text-center tracking-[var(--parahraphe-3-letter-spacing)] leading-[var(--parahraphe-3-line-height)] [font-style:var(--parahraphe-3-font-style)] w-full">
          ©2025 SDIExpertise®
        </div>
      </div>
    </footer>
