...
export const NewsletterSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-start gap-8 pt-[25px] pb-[33px] px-4 relative">
      <div className="flex flex-col w-full items-start relative">
        <Card className="items-start gap-4 p-4 w-full border border-solid border-[#346ca0] flex flex-col relative rounded-2xl overflow-hidden shadow-[inset_1.13e-16px_1.85px_1.85px_#ffffff,inset_-1.13e-16px_-1.85px_1.85px_#ebebeb] backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(142deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)]">
          <CardContent className="p-0 w-full flex flex-col gap-4">
            ...
            <div className="flex w-full h-8 items-center gap-2.5 px-[13px] py-0 bg-[#c9dceb] rounded-[9px]">
              <p className="w-full h-2 [font-family:'Ubuntu',Helvetica] font-normal text-xs tracking-[0] leading-3 whitespace-nowrap">
                ...
                <span className="font-medium text-[#0c26a6] leading-[21px]">
                  &nbsp;
                </span>
                <span className="font-medium text-[#346ca0] leading-[21px]">
            ...
            <div className="flex items-center gap-2.5 relative w-full">
              ...
              <Button
                type="submit"
                className="flex-[0_0_auto] h-auto p-0 bg-transparent hover:bg-transparent border-0"
              >
            ...
            <p className="[font-family:'Open_Sans',Helvetica] font-normal text-xs tracking-[0] leading-3">
              ...
              <span className="text-[#346ca0] leading-[var(--paragraphe-2-mobile-line-height)] font-paragraphe-2-mobile [font-style:var(--paragraphe-2-mobile-font-style)] font-[number:var(--paragraphe-2-mobile-font-weight)] tracking-[var(--paragraphe-2-mobile-letter-spacing)] text-[length:var(--paragraphe-2-mobile-font-size)]">
